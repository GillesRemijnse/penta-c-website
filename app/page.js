...
export default function Home() {
  return (
    <>
      <section className="max-w-6xl mx-auto px-6 pt-16 pb-16 md:pt-20 md:pb-20 lg:pt-24 lg:pb-24">
        <div className="max-w-5xl">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-x-3 gap-y-2 text-sm text-gray-500 md:flex-nowrap">
            <span className="whitespace-nowrap">40 jaar ervaring</span>
            <span aria-hidden="true" className="hidden text-gray-400 md:inline">
              /
            </span>
            <span className="whitespace-nowrap">Senior betrokkenheid</span>
            <span aria-hidden="true" className="hidden text-gray-400 md:inline">
              /
            </span>
            <span className="whitespace-nowrap">Discreet en zorgvuldig</span>
          </div>
        </div>
      </section>

      <section className="pt-20 pb-24 md:pt-24 md:pb-24">
