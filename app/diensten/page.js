        ...
        <div className="max-w-6xl mx-auto px-6 grid gap-8">
          <div className="bg-white rounded-2xl p-10 md:p-12 border border-[#EAE6E0] shadow-sm">
            <div className="grid md:grid-cols-[1.2fr_1fr] gap-10 items-start">
              <div>
                <h2 className="text-2xl md:text-3xl font-semibold">M&amp;A advisory</h2>
          ...
          <div className="bg-white rounded-2xl p-10 md:p-12 border border-[#EAE6E0] shadow-sm">
            <div className="grid md:grid-cols-[1.2fr_1fr] gap-10 items-start">
              <div>
                <h2 className="text-2xl md:text-3xl font-semibold">Management consultancy &amp; projectbegeleiding</h2>
                <p className="mt-5 text-gray-600 leading-8">
          ...
          <div className="bg-white rounded-2xl p-10 md:p-12 border border-[#EAE6E0] shadow-sm">
            <div className="grid md:grid-cols-[1.2fr_1fr] gap-10 items-start">
              <div>
                <h2 className="text-2xl md:text-3xl font-semibold">Legal Counsel</h2>
                <p className="mt-5 text-gray-600 leading-8">
      ...
      <section className="py-20 md:py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-10 grid md:grid-cols-4 gap-6">
            <div className="bg-white border border-[#EAE6E0] rounded-2xl p-6"><h3 className="font-semibold text-lg">Verkennen</h3><p className="mt-3 text-gray-600 leading-7">Inzicht krijgen in context, belangen en doelstellingen.</p></div>
            <div className="bg-white border border-[#EAE6E0] rounded-2xl p-6"><h3 className="font-semibold text-lg">Aanscherpen</h3><p className="mt-3 text-gray-600 leading-7">Het vraagstuk helder definiëren en structureren.</p></div>
            <div className="bg-white border border-[#EAE6E0] rounded-2xl p-6"><h3 className="font-semibold text-lg">Begeleiden</h3><p className="mt-3 text-gray-600 leading-7">Zorgvuldige uitvoering met aandacht voor kwaliteit en proces.</p></div>
            <div className="bg-white border border-[#EAE6E0] rounded-2xl p-6"><h3 className="font-semibold text-lg">Afronden</h3><p className="mt-3 text-gray-600 leading-7">Toewerken naar een helder besluit of een zorgvuldig resultaat.</p></div>
          </div>
        </div>
      </section>
